...
set Path=%MSVC%\VC\Redist\MSVC\14.16.27012\x86\Microsoft.VC141.CRT;%MSVC%\VC\Tools\MSVC\14.16.27023\bin\Hostx64\x86;%MSVC%\VC\Tools\MSVC\14.16.27023\bin\Hostx64\x64;%MSVC%\DIA SDK\bin\amd64;%WINSDK%\bin\x86;%WINSDK10%\bin\x86\ucrt;%Path%
